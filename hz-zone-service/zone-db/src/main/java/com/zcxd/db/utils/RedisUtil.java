...
//    }
    ...
    public <T> void hPut(String key,String filed,T domain){
...
//    }
    public <T> void hPutAll(String key, HashMap<String,T> hm){
     ...
     * @return
     */
    public Long sAddAll(String key, Set<String> values) {
