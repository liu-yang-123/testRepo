package com.zcxd.voucher.utils;
...
public class UserContextHolder {
    ...
    public static Long getBankId() {
        UserContextHolder.getInstance();
        return Optional.ofNullable(threadLocal.get()).orElse(new JSONObject()).getLong("bankId");
    }
    /**
     * 获取上下文中的用户
     *
    ...
    public static SysUser getUser() {
        return Optional.ofNullable(threadLocal.get()).orElse(new JSONObject()).toJavaObject(SysUser.class);
    }
    /**
     * 获取上下文中用户所属部门
     * @return
     */
    public static String getAuthDepartments() {
        return Optional.ofNullable(threadLocal.get()).orElse(new JSONObject()).getString("auth_departments");
    }
//    /**
//     * 获取上下文中用户所属部门
//     * @return
...
//        return Optional.ofNullable(threadLocal.get()).orElse(new JSONObject()).getLong("topDepartmentId");
//    }
    /**
     * 清空上下文
     */
