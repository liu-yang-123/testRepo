<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column
        v-if="hasPerm(['/base/pdaRole/update','/base/pdaRole/delete','/base/pdaRole/permissions/update'])"
        align="center"
        label="操作"
      ...
      >
        <template slot-scope="scope">
          <el-button
            v-permission="['/base/pdaRole/update']"
            type="primary"
            size="mini"
            @click="handleUpdate(scope.row)"
          >编辑</el-button>
          <el-button
            v-permission="['/base/pdaRole/delete']"
            type="danger"
            size="mini"
            @click="handleDelete(scope.row)"
          >删除</el-button>
          <el-button
            v-permission="['/base/pdaRole/permissions/update']"
            type="primary"
            size="mini"
...
<script>
import { listRole, createRole, updateRole, deleteRole, getPermission, updatePermission } from '@/api/pda/role'
...
export default {
  ...
  data() {
    return {
      ...
      role: {
        list: '/base/pdaRole/list',
        add: '/base/pdaRole/save'
      },
      listQuery: {
        page: 1,
        limit: 10,
