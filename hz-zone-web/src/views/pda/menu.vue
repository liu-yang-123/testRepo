<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-button v-permission="['/base/pdaMenu/save']" class="filter-item" type="primary" icon="el-icon-edit" @click="handleCreate">新增</el-button>
    </div>
    <!-- 查询结果 -->
    <el-table
    ...
    >
      ...
      <el-table-column align="center" label="操作" width="200" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            v-permission="['/base/pdaMenu/update']"
            type="primary"
            size="mini"
            @click="handleUpdate(scope.row)"
          >编辑</el-button>
          <el-button
            v-permission="['/base/pdaMenu/delete']"
            type="danger"
            size="mini"
...
<script>
import { listMenu, createMenu, updateMenu, deleteMenu } from '@/api/pda/menu'
